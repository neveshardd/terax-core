package world.terax.deliveries;

import world.terax.booster.Booster.BoosterType;
...
public class DeliveryReward {
  ...
  public void dispatch(Profile profile) {
    if (this.type == RewardType.COMANDO) {
      ...
      profile.setStats("CoreProfile", profile.getStats("CoreProfile", "cash") + (long) this.values[0], "cash");
