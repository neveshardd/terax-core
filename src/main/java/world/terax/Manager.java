...
public class Manager {
  ...
  static {
    try {
      ...
      Class<?> bungeeMain = Class.forName("world.terax.bungee.Bungee");
      ...
      try {
        ...
        Class<?> fakeManager = Class.forName("world.terax.player.fake.FakeManager");
        GET_NAME = Accessors.getMethod(player, "getName");
        GET_PLAYER = Accessors.getMethod(Class.forName("world.terax.player.Profile"), "findCached", String.class);
