package world.terax.player.scoreboard;

import world.terax.player.scoreboard.scroller.ScoreboardScroller;
...
public abstract class Scoreboard {
  ...
  public Scoreboard add(int line) {
    return add(line, "");
  }
  
  public Scoreboard add(int line, String name) {
  ...
  public Scoreboard to(Player player) {
  ...
  public Scoreboard display(String display) {
  ...
  public Scoreboard scroller(ScoreboardScroller ss) {
    this.scroller = ss;
    return this;
  }
  
  public Scoreboard health() {
    this.health = !health;
    if (this.scoreboard != null) {
      if (!this.health) {
