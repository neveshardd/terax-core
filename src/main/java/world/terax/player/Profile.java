...
import world.terax.database.data.container.*;
import world.terax.database.data.interfaces.AbstractContainer;
import world.terax.database.exception.ProfileLoadException;
import world.terax.game.Game;
import world.terax.game.GameTeam;
import world.terax.hook.FriendsHook;
import world.terax.player.enums.PlayerVisibility;
import world.terax.player.hotbar.Hotbar;
import world.terax.player.role.Role;
import world.terax.player.scoreboard.Scoreboard;
import world.terax.titles.TitleManager;
...
public class Profile {
  ...
  public void refresh() {
    ...
    if (!playingGame()) {
      ...
      this.getDataContainer("CoreProfile", "role").set(StringUtils.stripColors(Role.getPlayerRole(player, true).getName()));
    }
  ...
  public DeliveriesContainer getDeliveriesContainer() {
    return this.getAbstractContainer("CoreProfile", "deliveries", DeliveriesContainer.class);
  }

  public PreferencesContainer getPreferencesContainer() {
    return this.getAbstractContainer("CoreProfile", "preferences", PreferencesContainer.class);
  }
  
  public TitlesContainer getTitlesContainer() {
    return this.getAbstractContainer("CoreProfile", "titles", TitlesContainer.class);
  }
  
  public BoostersContainer getBoostersContainer() {
    return this.getAbstractContainer("CoreProfile", "boosters", BoostersContainer.class);
  }
  
  public AchievementsContainer getAchievementsContainer() {
    return this.getAbstractContainer("CoreProfile", "achievements", AchievementsContainer.class);
  }
  
  public SelectedContainer getSelectedContainer() {
    return this.getAbstractContainer("CoreProfile", "selected", SelectedContainer.class);
  }
