package world.terax.servers;

import world.terax.Core;
import world.terax.player.Profile;
import world.terax.plugin.config.Config;
import world.terax.servers.balancer.BaseBalancer;
import world.terax.servers.balancer.Server;
import world.terax.servers.balancer.type.LeastConnection;
...
public class ServerItem {
  ...
  public static final Config CONFIG = Core.getInstance().getConfig("servers");
