package world.terax.nms.v1_8_R3;
...
import world.terax.libraries.holograms.api.HologramLine;
import world.terax.libraries.npclib.api.npc.NPC;
import world.terax.libraries.npclib.api.npc.NPCAnimation;
import world.terax.libraries.npclib.npc.EntityControllers;
import world.terax.libraries.npclib.npc.ai.NPCHolder;
import world.terax.libraries.npclib.npc.skin.SkinnableEntity;
import world.terax.nms.interfaces.INMS;
import world.terax.nms.interfaces.entity.IArmorStand;
import world.terax.nms.interfaces.entity.IItem;
import world.terax.nms.interfaces.entity.ISlime;
import world.terax.nms.v1_8_R3.entity.EntityItem;
import world.terax.nms.v1_8_R3.entity.EntityNPCPlayer;
import world.terax.nms.v1_8_R3.entity.EntitySlime;
import world.terax.nms.v1_8_R3.entity.EntityStand;
import world.terax.nms.v1_8_R3.entity.HumanController;
import world.terax.nms.v1_8_R3.utils.PlayerlistTrackerEntry;
import world.terax.nms.v1_8_R3.utils.UUIDMetadataStore;
import world.terax.reflection.Accessors;
import world.terax.nms.v1_8_R3.entity.EntityArmorStand;
import world.terax.reflection.acessors.FieldAccessor;
import world.terax.utils.Utils;
...
public class NMS1_8R3 implements INMS {
  ...
  public NMS1_8R3() {
    ...
    CLASS_TO_NAME.get(null).put(EntityArmorStand.class, "Core-ArmorStand");
    CLASS_TO_ID.get(null).put(EntitySlime.class, 55);
    CLASS_TO_NAME.get(null).put(EntitySlime.class, "Core-Slime");
    CLASS_TO_ID.get(null).put(EntityItem.class, 1);
    CLASS_TO_NAME.get(null).put(EntityItem.class, "Core-Item");
