package world.terax.menus.profile;

import world.terax.Core;
import world.terax.libraries.menu.PlayerMenu;
import world.terax.menus.MenuProfile;
...
public class MenuStatistics extends PlayerMenu {
  ...
  public MenuStatistics(Profile profile) {
    ...
    this.setItem(14, BukkitUtils.deserializeItemStack(PlaceholderAPI.setPlaceholders(this.player,
        "STAINED_CLAY:11 : 1 : nome>&aThe Bridge : desc>&e1v1:\n &8▪ &fAbates: &7%Core_TheBridge_1v1kills%\n &8▪ &fMortes: &7%Core_TheBridge_1v1deaths%\n &8▪ &fPontos: &7%Core_TheBridge_1v1points%\n &8▪ &fVitórias: &7%Core_TheBridge_1v1wins%\n &8▪ &fPartidas: &7%Core_TheBridge_1v1games%\n " + "\n&e2v2:\n &8▪ &fAbates: &7%Core_TheBridge_2v2kills%\n &8▪ &fMortes: &7%Core_TheBridge_2v2deaths%\n &8▪ &fPontos: &7%Core_TheBridge_2v2points%\n &8▪ &fVitórias: &7%Core_TheBridge_2v2wins%\n &8▪ &fPartidas: &7%Core_TheBridge_2v2games%\n \n&eWinstreak:\n &8▪ &fDiário: &7%Core_TheBridge_winstreak%\n \n&fCoins: &6%Core_TheBridge_coins%")));
    
    this.setItem(16, BukkitUtils.deserializeItemStack(PlaceholderAPI.setPlaceholders(this.player,
        "BOW : 1 : nome>&aMurder : desc>&eClássico: \n &8▪ &fAbates: &7%Core_Murder_classic_kills%\n &8▪ &fVitórias: &7%Core_Murder_classic_wins%\n \n&eAssassinos: \n &8▪ &fAbates: &7%Core_Murder_assassins_kills%\n &8▪ &fVitórias: &7%Core_Murder_assassins_wins%\n \n&fCoins: &6%Core_Murder_coins%")));
  
    this.setItem(22, BukkitUtils.deserializeItemStack(PlaceholderAPI.setPlaceholders(this.player,
        "58 : 1 : nome>&aBuild Battle : desc>&eGeral: \n &8▪ &fVitórias: &7%Core_BuildBattle_wins%\n &8▪ &fPartidas: &7%Core_BuildBattle_games%\n &8▪ &fPontos: &7%Core_BuildBattle_points%\n \n&fCoins: &6%Core_BuildBattle_coins%")));
