package world.terax.libraries.holograms;
...
public class HologramLibrary {
  ...
  public static final Logger LOGGER = ((Logger) Core.getInstance().getLogger()).getModule("HOLOGRAMS");
  ...
  public static void setupHolograms(Plugin pl) {
    if (plugin != null) {
      return;
    }
